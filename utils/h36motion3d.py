...
class Datasets (Dataset ):
            ...
            for action_idx in np .arange (len (acts )):
                ...
                if self .split <=1 or opt .test_sample_num <0 :
                    for subact in [1 ,2 ]:
                        ...
                        self .labels .extend ([action_idx ]*len (valid_frames ))
                        key +=1 
                else :
    ...
    def __getitem__ (self ,item ):
        ...
        fs =np .arange (start_frame ,start_frame +self .in_n )
        fs1 =np .arange (start_frame +self .in_n +1 ,start_frame +self .in_n +self .out_n )[::2 ]
        fs2 =np .arange (start_frame +self .in_n +self .out_n -1 ,start_frame +self .in_n +self .out_n )
        if self .downsample :
